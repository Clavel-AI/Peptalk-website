...
export default function Home() {
  return (
    <section className="w-full bg-[#f4f9ff] py-10 px-4 pb-[4.5rem]">
      <div className="container mx-auto h-[350px] bg-gradient-to-r from-[#4a90e2] to-[#003087] text-white rounded-3xl p-8 flex flex-col md:flex-row items-center justify-between">
